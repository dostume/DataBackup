...
class MediumBackupUtil @Inject constructor(
    ...
    /**
     * Backs up a media item to cloud using volume splitting and, optionally,
     * streaming upload. Each volume is uploaded as soon as it is finalized and
     * deleted locally afterwards.
     */
    suspend fun backupMediaToCloud(
        m: MediaEntity,
        ...
        log { "Backing up ${DataType.MEDIA_MEDIA.type} to cloud..." }
        ...
        volumeBackupUtil.compressAndUpload(
            ...
            baseName = DataType.MEDIA_MEDIA.type,
            suffix = ct.suffix,
