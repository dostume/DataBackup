...
val KeyStreamUpload = booleanPreferencesKey("stream_upload")
...
fun Context.readStreamUpload() = readStoreBoolean(key = KeyStreamUpload, defValue = false)
...
suspend fun Context.saveStreamUpload(value: Boolean) = saveStoreBoolean(key = KeyStreamUpload, value = value)
