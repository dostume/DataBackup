...
val KeyVolumeSize = longPreferencesKey("volume_size")
...
fun Context.readVolumeSize() = readStoreLong(key = KeyVolumeSize, defValue = 0)
...
suspend fun Context.saveVolumeSize(value: Long) = saveStoreLong(key = KeyVolumeSize, value = value)
